...
public class ViewAdminAltaProfesor extends JPanel{

	private MainWindow mainWindow;
    private ControllerAdminAltaProfesor controllerAdminAltaProfesor;
	...
	public ViewAdminAltaProfesor(MainWindow mainWindow, ControllerAdminAltaProfesor controllerAdminAltaProfesor) {
        this.mainWindow = mainWindow;
        this.controllerAdminAltaProfesor = controllerAdminAltaProfesor;
	...
	private void inicializarComponentes(){
        lblAltaUsuario = new JLabel("Alta de Profesor");
    ...
    private void inicializarListeners(){
        ...
        btnRegistrar.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent actionEvent){
                ...
                Profesor profesor = new Profesor(email, password, nombre, apellido, legajo);

                controllerAdminAltaProfesor.darDeAltaProfesor(profesor);
            }
        });

        btnCancelar.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent actionEvent){
                controllerAdminAltaProfesor.regresarMenuPrincipalAdmin();
            }
        });
    }
