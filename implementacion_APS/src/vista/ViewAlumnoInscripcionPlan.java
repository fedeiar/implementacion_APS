...
public class ViewAlumnoInscripcionPlan extends JPanel{
    ...
    public ViewAlumnoInscripcionPlan(MainWindow mainWindow, ControllerAlumnoInscripcionPlan controllerAlumnoInscripcionPlan){
